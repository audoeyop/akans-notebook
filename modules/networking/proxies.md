...
![Forward Proxy Flow](assets/forward-proxy-flow.svg)
...
A reverse proxy is a server that sits in front of web servers and forwards client (e.g. web browser) requests to those web servers. Reverse proxies are typically implemented to help increase security, and reliability. In order to better understand how a reverse proxy works and the benefits it can provide, let's first define what a proxy server is.
...
![Reverse Proxy Flow](assets/reverse-proxy-flow.svg)
